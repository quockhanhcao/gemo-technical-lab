      ...
      <div className="modal-content" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="modal-body">
          <form action="">
            ...
            <div>
              <div>
                <label htmlFor="WHOLE_MILK">Whole milk</label>
              </div>
              <input type="radio" id="WHOLE_MILK" name="milkType" value="WHOLE_MILK" />
            </div>
            <div>
              <div>
                <label htmlFor="ALMOND_MILK">Almond milk</label>
              </div>
              <input type="radio" id="ALMOND_MILK" name="milkType" value="ALMOND_MILK" />
            </div>
